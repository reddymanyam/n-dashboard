...
import { Box, TextField, FormControl, InputLabel, OutlinedInput, InputAdornment, IconButton, Select, MenuItem, Button, FormControlLabel, Checkbox, Paper } from '@mui/material';
...
export default function User() {
  ...
  return (
    <Box  width="60%" justifyContent="center" alignItems="center" margin="0 auto" maxWidth="600"  padding= '30px' height="100vh" >
      <Paper elevation={6}  sx={{padding:"30px", width:"100%"}}>
